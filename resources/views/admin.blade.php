        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
					<h3>Narudzbe</h3>
					<ul class="nav col-md-12 col-md-offset-0">
						<li class="col-md-3 col-md-offset-3">
							<a href="{{ route('admin') }}"><button type="button" class="btn btn-default btn-md btn-block">Aktivne</button></a>
						</li>
						<li class="col-md-3 col-md-offset-0">
							<a href="{{ route('admin_finish') }}"><button type="button" class="btn btn-default btn-md btn-block">Zavrsene</button></a>
						</li>
					</ul>
					<br>
					<br>
										  ...
										  <div class="modal-dialog" role="document">
											<div class="modal-content">
											  <div class="modal-header">
												...
												<form method="POST" action="{{ route('updateStatusOrder', ['id' => $order->id]) }}">
												<input type="hidden" name="_token" value="{{ csrf_token() }}">
												  ...
												  <div class="modal-footer">
													...
													<button type="submit" class="btn btn-primary">Zavrsi narudzbu</button>
												  </div>
												</form>
											</div>
										  </div>
